...
INSECURE_REGISTRY='--insecure-registry rcm-img-docker01.build.eng.bos.redhat.com:5001 --insecure-registry docker-registry.usersys.redhat.com --insecure-registry 172.30.0.0/16 --insecure-registry hub.$1'
EOF
